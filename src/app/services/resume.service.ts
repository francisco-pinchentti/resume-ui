...
const INITIAL_DATASET: Resume[] = [
  ...
  { "id": "2", "fullname": "John Doe", "position": "Fullstack developer", "bio": "By day I code, at nights I fight crime with \"bash\"", "skills": [{ "name": "javascript", "grade": 4 }, { "name": "java", "grade": 4 }, { "name": "mysql", "grade": 3 }, { "name": "mongodb", "grade": 2 }, { "name": "git", "grade": 5 }, { "name": "bash", "grade": 5 }], "languages": [{ "name": "italian", "grade": 5 }, { "name": "english", "grade": 3 }], "experiences": [{ "position": "Backend developer", "company": "GL", "summary": "mantaned a java mvc application", "from": "2011-02-16T03:00:00.000Z", "to": "2014-02-10T03:00:00.000Z" }, { "position": "Frontend developer", "company": "InfoSys Supercorp", "summary": "We developed a mobile client for a secret project don't tell anyone", "from": "2014-03-01T03:00:00.000Z", "to": "2018-12-31T03:00:00.000Z" }], "contact": { "email": "jd@nomail.com", "github": "jd.nono.github.com", "linkedIn": "", "skypeID": "", "website": "www.jdnnn.com" } }
];
